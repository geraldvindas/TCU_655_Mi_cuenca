...
//
//public class MenuMapaArcgis extends Activity {
//
...
//                Intent next = new Intent(MenuMapaArcgis.this, Mapa.class);
//                startActivity(next);
//            }
//        });
//
...
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, Leyes.class);
//                startActivity(next);
//            }
//        });
//
...
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, ASADAS.class);
//                startActivity(next);
//            }
//        });
//        datos.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, DatosCuriosos.class);
//                startActivity(next);
//            }
//        });
//
...
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, Zonificacion.class);
//                startActivity(next);
//            }
//        });
//
//        conceptos.setOnClickListener(new View.OnClickListener() {
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, Conceptos.class);
//                startActivity(next);
//            }
//        });
//
...
//            public void onClick(View v) {
//                Intent next = new Intent(MenuMapaArcgis.this, Recursos.class);
//                startActivity(next);
//            }
//        });
//
