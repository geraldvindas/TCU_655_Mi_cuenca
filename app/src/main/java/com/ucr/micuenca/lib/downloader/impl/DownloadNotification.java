...
import com.ucr.micuenca.lib.downloader.DownloaderClientMarshaller;
...
public class DownloadNotification implements IDownloaderClient {
    ...
    public void onDownloadStateChanged(int newState) {
        ...
        if (newState != mState) {
            ...
            builder.setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), iconResource));
    ...
    public void onDownloadProgress(DownloadProgressInfo progress) {
        ...
        if (progress.mOverallTotal <= 0) {
            ...
            Notification.Builder builder = new Notification.Builder(mContext);
            builder.setTicker(mLabel + ": " + mCurrentText);
            builder.setLargeIcon(BitmapFactory.decodeResource(mContext.getResources(), android.R.drawable.stat_sys_download));
            builder.setContentTitle(mCurrentTitle);
            builder.setContentIntent(mContentIntent);
            builder.setContentText(mCurrentText);
